    ...
    <>
      <div className="bg-blue_gray-800 font-cousine h-[1024px] mx-auto relative w-full">
        ...
        <div className="md:h-[1722px] sm:h-[889px] h-[950px] mt-auto mx-auto md:px-5 w-full">
          ...
          <div className="absolute bg-blue_gray-100 flex flex-col gap-6 justify-start p-3.5 right-[0] rounded-[10px] top-[0] w-[41%]">
            <div className="flex flex-col gap-[38px] items-start justify-start ml-9 md:ml-[0] mt-1 w-[94%] md:w-full">
              ...
              <div className="h-[104px] relative w-[90%] sm:w-full">
                <Text
                  className="absolute inset-x-[0] mx-auto text-black-900 text-xl top-[20%] w-max"
                ...
                <Img
                  className="absolute h-[104px] inset-y-[0] my-auto object-cover right-[0] rounded-[20px] w-[95%]"

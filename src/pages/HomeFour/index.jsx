    ...
    <>
      <div className="bg-blue_gray-800 font-cousine h-[1024px] mx-auto relative w-full">
        ...
        <div className="md:h-[1722px] sm:h-[889px] h-[950px] mt-auto mx-auto md:px-5 w-full">
          ...
          <div className="absolute bg-blue_gray-800 flex flex-col gap-[41px] justify-center p-[11px] right-[0] rounded-[10px] top-[0] w-[41%]">
            <div className="flex flex-col items-center justify-start md:ml-[0] ml-[9px] mr-[441px] mt-[35px]">
              <Text
            ...
            <div className="flex flex-col gap-[17px] items-center justify-start mb-[132px] w-full">
              <Button
                className="common-pointer border-[5px] border-amber-300 border-solid cursor-pointer leading-[normal] min-w-[564px] sm:min-w-full text-3xl sm:text-[26px] md:text-[28px] text-center"
              ...
              <Button
                className="common-pointer border-[5px] border-amber-300 border-solid cursor-pointer leading-[normal] min-w-[564px] sm:min-w-full text-3xl sm:text-[26px] md:text-[28px] text-center"
                onClick={() => navigate("/homeseven")}
                shape="round"
              >
                Opciones
              </Button>
              <Button
                className="common-pointer !text-black-900 border-[5px] border-amber-300 border-solid cursor-pointer leading-[normal] min-w-[564px] sm:min-w-full text-3xl sm:text-[26px] md:text-[28px] text-center"
                onClick={() => navigate("/homesix")}
                shape="round"
              >
                Ayuda y Opiniones.
              </Button>

...
const HomeSixPage = () => {
  ...
  return (
    <>
      <div className="bg-blue_gray-800 flex flex-col font-cousine mx-auto relative w-full">
        <div className="h-[187px] mx-auto md:px-5 w-full">
        ...
        <div className="md:h-[1668px] sm:h-[836px] h-[950px] mt-[-54px] mx-auto md:px-5 w-full z-[1]">
          ...
          <div className="absolute md:h-[1722px] sm:h-[890px] h-[891px] inset-x-[0] mx-auto top-[0] w-full">
            ...
            <div className="absolute bg-blue_gray-800 flex flex-col md:gap-10 gap-[72px] h-full inset-y-[0] justify-start my-auto p-5 right-[0] rounded-[10px] w-[41%]">
              <div className="flex flex-col items-center justify-start mt-1.5">
                <Text
                  className="sm:text-4xl md:text-[38px] text-[40px] text-amber-300 w-full"
                  size="txtCousineBold40"
                >
                  Ayuda y opiniones
                </Text>
              </div>
              <div className="flex flex-col items-start justify-start mb-[43px] md:ml-[0] ml-[47px] mr-2.5 w-[90%] md:w-full">
                <Text
                ...
                <div className="bg-blue_gray-800 border-2 border-amber-300 border-solid flex flex-col items-start justify-start md:ml-[0] ml-[5px] mt-[93px] p-2.5 w-[99%] md:w-full">
                  <div className="flex flex-col items-center justify-start mb-[121px] ml-2 md:ml-[0]">
                    <Text
                      className="text-3xl sm:text-[26px] md:text-[28px] text-amber-300 text-center"
                ...
                <Button
                  className="cursor-pointer font-bold leading-[normal] min-w-[306px] md:ml-[0] ml-[81px] mt-[88px] rounded-[20px] sm:text-3xl md:text-[32px] text-[34px] text-center"
                  color="blue_gray_100"
                  size="md"
                >
                  Enviar
